function solve() {
    const inputElements = {
       ...
       const otherDOMSelectors = {
           ...
           open: document.querySelector("body > main > div > section:nth-child(2) > div:nth-child(2)"),
    ...
    function onAdd(e) {
        ...
        let article = createElement('article', otherDOMSelectors.open);
        ...
        function onStart() {
            ...
            otherDOMSelectors.inProgress.appendChild(article);
        ...
        function onFinish() {
            let article = this.parentNode.parentNode;
            otherDOMSelectors.complete.appendChild(article);
